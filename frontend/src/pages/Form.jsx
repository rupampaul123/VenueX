...
export default function Form() {
  ...
  async function handlesubmit(e) {
    e.preventDefault();
    try {
      const res = await fetch('https://venuex-bmu7.onrender.com/form', {
        method: 'POST',
      ...
      <div className="min-h-screen flex items-center justify-center bg-white px-4">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-6">
          ...
          <form className="space-y-4" onSubmit={handlesubmit}>
            ...
            <div>
              <label htmlFor="location" className="block text-sm font-medium text-[#2563EB]">
                Venue Location
              </label>
              <select
            ...
            <div>
              <label htmlFor="price" className="block text-sm font-medium text-[#2563EB]">
                Venue Price
              </label>
              <input
                value={price}
            ...
            <div>
              <label htmlFor="content" className="block text-sm font-medium text-[#2563EB]">
            ...
            <div>
              <label htmlFor="image" className="block text-sm font-medium text-[#2563EB]">
                Venue Image
              </label>
              <input
        ...
        <img src="/For sale-rafiki.png" style={{ height: '600px', width: '600px' }} />
      </div>
    </>
  );
}
