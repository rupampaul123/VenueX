...
export default function Booked() {
  ...
  useEffect(() => {
    fetch('https://venuex-bmu7.onrender.com/booked', {
      credentials: 'include',
    })
      .then(res => res.json())
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-50">
      ...
      {venues.length === 0 ? (
        <div className="text-center text-gray-600 text-lg pb-16">You have no bookings yet.</div>
      ) : (
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 pb-16">
          {venues.map(venue => (
            ...
            >
              <img src={venue.url} alt={venue.name} className="h-48 w-full object-cover" />
