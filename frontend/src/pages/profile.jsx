        ...
        <>
            ...
            <div className="relative min-w-screen h-80 mx-5 my-5 rounded-3xl overflow-hidden bg-slate-600 flex justify-center items-center">
                <div className="w-36 h-36 rounded-full bg-red-800 z-30 absolute -top-18">
                    <img className="w-full h-full object-cover rounded-full" src="https://img.freepik.com/free-vector/blue-circle-with-white-user_78370-4707.jpg?semt=ais_incoming&w=740&q=80"/>
                </div>
...
<Link to="/" ><Button onClick={handlelogout} className="mb-24">Signout</Button></Link>
</div>
