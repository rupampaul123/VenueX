...
export default function Listed() {
  ...
  useEffect(() => {
    fetch('https://venuex-bmu7.onrender.com/listed', {
      credentials: 'include',
    })
      .then(res => res.json())
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold text-gray-800 mb-2">
          Listed <span className="text-blue-600">Venues</span> By You
        </h1>
        <p className="text-gray-600 mb-6">Get all your Listings here</p>
      </div>

      {venues.length === 0 ? (
        <div className="text-center text-gray-600 text-lg pb-16">You have no Listings yet.</div>
      ) : (
